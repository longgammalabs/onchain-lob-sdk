...
var getParams = (amount, amountUSD, lpAmount, slippage, tokenDecimals, lpTokenDecimals) => {
  ...
  return {
    amount: (0, import_ethers4.parseUnits)(amount.toString(), tokenDecimals),
    amountUsd: (0, import_ethers4.parseUnits)(amountUSD.toString(), USD_DECIMALS),
    minLpMinted: (0, import_ethers4.parseUnits)(minLpMintedWithSlippage.toString(), lpTokenDecimals)
  };
};
...
var getWithdrawDetails = ({
  ...
  if (isLpTokenInput) {
    const lpAmountSpend = (0, import_bignumber9.default)(lpInput).dp(lpTokenDecimals, import_bignumber9.default.ROUND_FLOOR);
    const usdAmountSpend = lpAmountSpend.times(totalValue).div(totalSupply).dp(tokenDecimals, import_bignumber9.default.ROUND_FLOOR);
    const usdAmountReceive = usdAmountSpend.times((0, import_bignumber9.default)(1).minus(maxFeeBps));
    const feeAmountUSD = (0, import_bignumber9.default)(usdAmountSpend).minus(usdAmountReceive);
    const tokenReceive = usdAmountReceive.div(tokenPriceUSD).dp(tokenDecimals, import_bignumber9.default.ROUND_FLOOR);
...
var getParams2 = (amount, amountUSD, lpAmount, slippage, tokenDecimals, lpTokenDecimals) => {
  ...
  return {
    burnLP: (0, import_ethers5.parseUnits)(lpAmount.toString(), lpTokenDecimals),
    minTokenGet: (0, import_ethers5.parseUnits)(minTokenGetWithSlippage.toString(), tokenDecimals),
    minUsdValue: (0, import_ethers5.parseUnits)(minUsdValueWithSlippage.toString(), USD_DECIMALS)
  };
};
...
var _OnchainLobVaultContract = class _OnchainLobVaultContract {
  constructor(options) {
    ...
    this.fastWaitTransactionTimeout = options.fastWaitTransactionTimeout;
    this.vaultContract = new import_ethers6.Contract(options.vault.vaultAddress, lpManagerAbi, options.signer);
  ...
  async approveTokens(params) {
    ...
    const tokenContract = new import_ethers6.Contract(
