...
var getWithdrawDetails = ({
  ...
  if (isLpTokenInput) {
    const lpAmountSpend = BigNumber9(lpInput).dp(lpTokenDecimals, BigNumber9.ROUND_FLOOR);
    const usdAmountSpend = lpAmountSpend.times(totalValue).div(totalSupply).dp(tokenDecimals, BigNumber9.ROUND_FLOOR);
    const usdAmountReceive = usdAmountSpend.times(BigNumber9(1).minus(maxFeeBps));
