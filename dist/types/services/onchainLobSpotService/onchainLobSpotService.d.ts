 ...
 */
export declare class OnchainLobSpotService extends RemoteService {
    /**
     ...
     */
    getClobDepth(params: GetClobDepthParams): Promise<ClobDepthDto>;
    /**
    ...
    getUserDeposits(params: GetUserDepositsParams): Promise<UserDepositsDto>;
}
