import type { Token, Market, Orderbook, ClobDepth, Trade, MarketUpdate, OrderbookUpdate, ClobDepthUpdate, TradeUpdate, OrderUpdate, FillUpdate, Fill, OrderHistoryUpdate } from '../models';
import type { TokenDto, MarketDto, OrderbookDto, ClobDepthDto, TradeDto, FillDto } from '../services/onchainLobSpotService';
import type { FillUpdateDto, MarketUpdateDto, OrderHistoryUpdateDto, OrderUpdateDto, OrderbookUpdateDto, TradeUpdateDto, ClobDepthUpdateDto } from '../services/onchainLobSpotWebSocketService/dtos';
export declare const mapTokenDtoToToken: (dto: TokenDto) => Token;
export declare const mapClobDepthDtoToClobDepth: (dto: ClobDepthDto) => ClobDepth;
...
export declare const mapClobDepthUpdateDtoToClobDepthUpdate: (_marketId: string, dto: ClobDepthUpdateDto) => ClobDepthUpdate;
