 ...
 */
export declare class OnchainLobSpot implements Disposable {
    /**
     ...
     */
    setSigner(signer: Signer | null, options?: {
        customSignTransaction?: CustomSignTransaction;
    }): OnchainLobSpot;
    /**
    ...
    * @return {Promise<ContractTransactionResponse>} A Promise that resolves to the transaction response.
    */
    wrapNativeTokens(params: WrapNativeTokenSpotParams): Promise<ContractTransactionResponse>;
    /**
    ...
    * @return {Promise<ContractTransactionResponse>} A Promise that resolves to the transaction response.
    */
    unwrapNativeTokens(params: UnwrapNativeTokenSpotParams): Promise<ContractTransactionResponse>;
    /**
    ...
    */
     ...
     */
    getClobDepth(params: GetClobDepthParams): Promise<ClobDepth>;
    /**
     ...
     */
    getUserDeposits(params: GetUserDepositsParams): Promise<UserDeposits>;
    /**
    ...
    protected getSpotMarketContract(params: {
        market: string;
    }): Promise<OnchainLobSpotMarketContract>;
    protected attachEvents(): void;
    protected detachEvents(): void;
    protected onMarketUpdated: Parameters<typeof this.onchainLobWebSocketService.events.marketUpdated['addListener']>[0];
    protected onAllMarketsUpdated: Parameters<typeof this.onchainLobWebSocketService.events.allMarketsUpdated['addListener']>[0];
    protected onOrderbookUpdated: Parameters<typeof this.onchainLobWebSocketService.events.orderbookUpdated['addListener']>[0];
    protected onClobDepthUpdated: Parameters<typeof this.onchainLobWebSocketService.events.clobDepthUpdated['addListener']>[0];
    protected onTradesUpdated: Parameters<typeof this.onchainLobWebSocketService.events.tradesUpdated['addListener']>[0];
    protected onUserOrdersUpdated: Parameters<typeof this.onchainLobWebSocketService.events.userOrdersUpdated['addListener']>[0];
    protected onUserOrderHistoryUpdated: Parameters<typeof this.onchainLobWebSocketService.events.userOrderHistoryUpdated['addListener']>[0];
    protected onUserFillsUpdated: Parameters<typeof this.onchainLobWebSocketService.events.userFillsUpdated['addListener']>[0];
    protected onCandlesUpdated: Parameters<typeof this.onchainLobWebSocketService.events.candlesUpdated['addListener']>[0];
