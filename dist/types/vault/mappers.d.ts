...
export declare const mapVaultTotalValuesDtoToVaultTotalValues: (dto: VaultTotalValuesDto, tokens: Token[]) => VaultTotalValues;
...
export declare const mapVaultTotalValuesUpdateDtoToVaultTotalValuesUpdate: (dto: VaultTotalValuesUpdateDto, tokens: Token[]) => VaultTotalValuesUpdate;
