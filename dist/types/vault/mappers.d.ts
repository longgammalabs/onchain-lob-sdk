import type { Token, VaultTotalValues, VaultDepositAction, VaultDepositor, VaultTotalValuesUpdate, VaultDepositActionUpdate, VaultDepositorUpdate, VaultConfig } from '../models';
...
export declare const mapVaultConfigDtoToVaultConfig: (dto: VaultConfigDto) => VaultConfig;
